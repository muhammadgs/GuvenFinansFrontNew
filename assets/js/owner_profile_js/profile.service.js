...
class ProfileService {
    ...
    async updateProfile(profileData) {
        ...
        console.log('📤 Sending to API (WITH company_name):', updateData);
        ...
        try {
            ...
            // ✅ ƏSAS DÜZƏLİŞ: Şirkət adını localStorage-da yenilə
            if (profileData.company_name) {
                ...
                if (savedData) {
                    try {
                        ...
                        if (parsed.user) {
                            parsed.user.company_name = profileData.company_name;
                        } else {
                            parsed.company_name = profileData.company_name;
                        }
                        localStorage.setItem('userData', JSON.stringify(parsed));
                        console.log('💾 Şirkət adı localStorage-da yeniləndi:', profileData.company_name);
                    } catch (e) {
            ...
            if (this.auth.currentUser) {
                this.auth.currentUser = {
                    ...
                    company_name: updateData.company_name || this.auth.currentUser.company_name
                };
                localStorage.setItem('userData', JSON.stringify(this.auth.currentUser));
            }

            console.log('✅ Profil tam yeniləndi (şirkət adı daxil)');
            return response;
